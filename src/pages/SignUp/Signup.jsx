        ...
        <div className='form_container'>
          <div className='fn_container'>
            ...
            <input
              ...
              onChange={change}
            />
            {error.firstName && <p className='input-error'>{error.firstName}</p>}            
          </div>
          <div className='ln-container'>
            ...
            <input
              ...
              onChange={change}
            />
            {error.lastName && <p className='input-error'>{error.lastName}</p>}  
          </div>
          ...
          <div className='phone-container'>
            ...
            <input
              ...
              onChange={change}
            />
            {error.phoneNumber && <p className='input-error'>{error.phoneNumber}</p>}  
          </div>
          ...
          <div className='btn'>
            <button className='btnSignup' onClick={submit}>Sign Up</button>
          </div>
          <p className='orContainer'>Or</p>
          <p className='text_container'>Already have an account? &nbsp;
